...
public class KeyEventManager {
    ...
    public boolean removeHandler(KeyCode keyCode, EventHandler<KeyEvent> handler) {
        List<EventHandler<KeyEvent>> handlersForKey = this.handlers.get(keyCode);
        if (handlersForKey != null) {
            return handlersForKey.remove(handler);
        }
